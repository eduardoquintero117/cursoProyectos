...
//  App iTunes
//
//  Created by Eduardo Quintero on 04/03/20.
...
class TunesTableViewController: UITableViewController , UISearchBarDelegate{
    ...
    struct Track: Codable {
       ...
       */
       ...
       func getTracks(_ cadena: String){
           let stringConverted = cadena.replacingOccurrences(of: " ", with: "%20")
           let url = URL(string: "http://itunes.apple.com/search?term=\(stringConverted)")
